...
class VisionTransformer_POSTER(nn.Module):
    def __init__(self, img_size=14, patch_size=14, in_c=48, num_classes=8,
        ...
        """
        super(VisionTransformer_POSTER, self).__init__()
        self.num_classes = num_classes
        ...
        # DEVO CAMBIARE LA DIMENSIONE DI POS EMBED IN 49
