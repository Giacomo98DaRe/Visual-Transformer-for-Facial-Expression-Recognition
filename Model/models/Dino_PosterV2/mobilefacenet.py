...
class MobileFaceNet(Module):
    def __init__(self, input_size, embedding_size, output_name="GDC"):
    ...
    def forward(self, x):
        ...
        # out_first = self.output_layer(out3)
        # print(out.shape)
        out = self.conv_34(out3) # [64, 28, 28]
        # print(out.shape)
        out4 = self.conv_4(out)  # [128, 14, 14]
        # out_second = self.output_layer(out4)
        # print(out.shape)
        ...
        # out_third = self.output_layer(conv_features)
