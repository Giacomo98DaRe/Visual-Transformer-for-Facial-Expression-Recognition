...
class Dino_PosterV2(nn.Module):
    ...
    def forward(self, x, dims=[64, 128, 256]):
        ...
        # NELLA SECONDA FASE ESTRAGGO I BACKBONE DELL'IMMAGINE
        # x_ir1, x_ir2, x_ir3 = self.Dino(x)
        ...
        features_1, features_2, features_3 = features_1.view(batch_dim, dims[0], 28, 28), features_2.view(batch_dim, dims[1], 14, 14), features_3.view(batch_dim, dims[2], 7, 7)
        x_window1, shortcut1 = self.window1(features_1)
        x_window2, shortcut2 = self.window2(features_2)
        x_window3, shortcut3 = self.window3(features_3)


       # IT WOULD BE RIGHT TO THINK ABOUT EVERYTHING IN PARALLEL. NOW THAT I'VE ALREADY EXTRACTED THE BACKBONES AND LANDMARKS, I APPLY
       # THE W-SELF-ATTENTION AND FINALLY THE VIT.
